...
public class BookClubReviewService implements BookClubReviewUseCase {
    ...
    @Override
    public List<BookClubReview> getUserReviews(Long userId, Pageable pageable, OrderType orderType, boolean includeInactive) {
        return bookClubReviewPort.findUserReviews(userId, pageable, orderType, includeInactive);
    }
}
