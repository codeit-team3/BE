...
public record ScoredBookClubReviewResponses(Double averageScore, List<BookClubReviewResponse> reviews, BookClubReviewCountResponse ratingCounts) {
    public static ScoredBookClubReviewResponses from(ScoredBookClubReview scoredBookClubReview) {
        List<BookClubReviewResponse> bookClubReviewResponses = scoredBookClubReview.getBookClubReviews()
                ...
                .toList();
        return new ScoredBookClubReviewResponses(scoredBookClubReview.getScore(), bookClubReviewResponses, BookClubReviewCountResponse.from(scoredBookClubReview.getBookClubReviewCount()));
    }
}
