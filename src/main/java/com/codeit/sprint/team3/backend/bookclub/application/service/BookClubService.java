...
public class BookClubService implements BookClubUseCase {
    ...
    @Override
    public List<BookClub> findBookClubsBy(BookClubType bookClubType, MeetingType meetingType, Integer memberLimitMin, Integer memberLimitMax, String location, LocalDateTime targetDate, OrderType orderType, Pageable pageable, String searchKeyword, Long userId, Boolean isAvailable) {
        return queryBookClubPort.findBookClubsBy(bookClubType, meetingType, memberLimitMin, memberLimitMax, location, targetDate, orderType, pageable, searchKeyword, userId, isAvailable);
    }
    ...
    public List<BookClub> findMyCreatedBookClubs(Long userId, Long targetUserId, OrderType orderType, Pageable pageable, boolean includeInactive) {
        return queryBookClubPort.findMyCreatedBookClubs(userId, targetUserId, orderType, pageable, includeInactive);
    }
    ...
    public List<BookClub> findUserJoinedBookClubs(Long userId, Long targetUserId, OrderType orderType, Pageable pageable, boolean includeInactive) {
        return queryBookClubPort.findUserJoinedBookClubs(userId, targetUserId, orderType, pageable, includeInactive);
    }
}
